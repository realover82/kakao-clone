...
def main():
    ...
    if 'show_details_pcb' not in st.session_state:
        st.session_state['show_details_pcb'] = False
    if 'show_details_fw' not in st.session_state:
        st.session_state['show_details_fw'] = False
    if 'show_details_rftx' not in st.session_state:
        st.session_state['show_details_rftx'] = False
    if 'show_details_semi' not in st.session_state:
        st.session_state['show_details_semi'] = False
    if 'show_details_func' not in st.session_state:
        st.session_state['show_details_func'] = False
